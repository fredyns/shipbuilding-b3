                ...
                <div class="flex flex-wrap">
                    <div class="mb-4 w-full">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.shipbuilding-tasks.inputs.name')
                        </h5>
                        <span> {{ $shipbuildingTask->name ?? '-' }} </span>
                    </div>
                    <div class="mb-4 w-full">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.shipbuilding-tasks.inputs.description')
                        </h5>
                        <span>
                    ...
                    <div class="mb-4 w-full">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.shipbuilding-tasks.inputs.weight')
                        </h5>
                        <span> {{ $shipbuildingTask->weight ?? '-' }} </span>
                    </div>
                    <div class="mb-4 w-full">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.shipbuilding-tasks.inputs.progress')
                        </h5>
                        <span> {{ $shipbuildingTask->progress ?? '-' }} </span>
                    </div>
                    <div class="mb-4 w-full">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.shipbuilding-tasks.inputs.target')
                        </h5>
                        <span> {{ $shipbuildingTask->target ?? '-' }} </span>
                    </div>
                    <div class="mb-4 w-full">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.shipbuilding-tasks.inputs.deviation')
                        </h5>
